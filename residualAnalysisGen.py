###Program to find the avg optimum cutoff frequency of all the columns in the dataset
### and to store the newly filtered (filtered with the avg fc_opt) dataset in a new csv.
...
u, v = np.shape(data)
myData = []
myData.append(["Frames","Time"])
for i in range(len(data)):
    myData.append([frame[i], time[i]])
